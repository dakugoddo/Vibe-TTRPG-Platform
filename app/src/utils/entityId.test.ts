...
import { formatEntityTimestampId, generateEntityId, isTimestampEntityId } from './entityId';
...
test('isTimestampEntityId accepts only 17 digit timestamp ids', () => {
    assert.equal(isTimestampEntityId('20260102030405006'), true);
    assert.equal(isTimestampEntityId('2026010203040500'), false);
    assert.equal(isTimestampEntityId('20260102030405006a'), false);
});
