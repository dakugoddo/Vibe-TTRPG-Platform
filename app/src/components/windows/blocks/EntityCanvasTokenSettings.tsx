...
const TOKEN_MODES: Array<{ id: EntityTokenMode; labelKey: string; icon: typeof Box }> = [
    { id: 'token', labelKey: 'canvasTokenSettings.modes.token', icon: Box },
    { id: 'art', labelKey: 'canvasTokenSettings.modes.art', icon: ImageIcon },
];
    ...
    return (
        <section className="rounded-[var(--vibe-radius-md)] border border-[var(--vibe-border-subtle)] bg-[var(--vibe-surface-block)] p-3 shadow-[var(--vibe-shadow-block)]">
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_1.2fr]">
                <div>
                    <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-[var(--vibe-text-faint)]">{t('canvasTokenSettings.mode')}</div>
                ...
                <div>
                    <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-[var(--vibe-text-faint)]">{t('canvasTokenSettings.frame')}</div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
                <label className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-[var(--vibe-text-muted)]">
                    ...
                    />
                    <Eye size={12} />
                    {t('canvasTokenSettings.nameOnCanvas')}
                </label>

                <label className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-[var(--vibe-text-muted)]">
                    <span>{t('canvasTokenSettings.frameColor')}</span>
                    <input
                        type="color"
            ...
            <div className="mt-3 grid gap-2 md:grid-cols-2">
                <label className="min-w-0">
                    <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-[var(--vibe-text-faint)]">{t('canvasTokenSettings.tokenPhoto')}</div>
                    <select
                        ...
                        title={t('canvasTokenSettings.mainPhotoHint')}
                    >
                        <option value="">{t('canvasTokenSettings.mainPhoto')}</option>
                ...
                <label className="min-w-0">
                    <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-[var(--vibe-text-faint)]">{t('canvasTokenSettings.cardPhoto')}</div>
                    <select
