...
// Layout Variants
const VARIANTS = [
    { id: 'v1', key: 'compactLists' },
    { id: 'v2', key: 'cardView' },
    { id: 'v3', key: 'detailedRadial' }
];
            ...
            <div className="flex-shrink-0 bg-black/40 backdrop-blur-xl border-b border-white/10 p-4 flex items-center justify-between z-10 relative shadow-2xl">
                ...
                <div className="flex bg-black/50 p-1.5 rounded-xl border border-white/5 shadow-inner flex-1 max-w-2xl mx-6 justify-center gap-2">
                    {VARIANTS.map(variant => (
                        ...
                        >
                            {t(`styleDemo.variants.${variant.key}.short`)}
                        </button>
                    ))}
                </div>
                ...
                <div className={`w-[950px] flex flex-col ${glass.window} transition-all duration-300 relative`}>
                    ...
                    <div className={`${glass.header} flex items-center justify-between`}>
                        <div className="flex items-center gap-3">
                            ...
                            <span className={glass.titleText}>{t('styleDemo.sampleCharacter')}</span>
                        </div>
                        <div className="flex items-center gap-3">
                    ...
                    <div className={glass.content}>
                        ...
                        <div className="flex gap-6 border-b border-white/10 pb-2 mb-2">
                            <button onClick={() => setActiveTab('stats')} className={`pb-2 border-b-2 font-bold text-sm uppercase tracking-wide transition-colors ${activeTab === 'stats' ? 'border-white/60 text-white/60' : 'border-transparent text-white/40 hover:text-white/70'}`}>{t('styleDemo.tabs.stats')}</button>
                            ...
                            <button onClick={() => setActiveTab('notes')} className={`pb-2 border-b-2 font-bold text-sm uppercase tracking-wide transition-colors ${activeTab === 'notes' ? 'border-white/60 text-white/60' : 'border-transparent text-white/40 hover:text-white/70'}`}>{t('styleDemo.tabs.notes')}</button>
                        </div>
                ...
                <div className={`absolute left-10 top-1/3 w-48 flex flex-col overflow-hidden bg-[#151c2b]/70 backdrop-blur-3xl border border-white/10 rounded-xl shadow-[0_15px_40px_rgba(0,0,0,0.6)] z-20`}>
                    ...
                    <div className="p-1 flex flex-col gap-0.5">
                        <button className={`w-full text-left px-3 py-2 text-sm rounded-md hover:bg-white/10 transition-colors flex items-center gap-3 text-white/80`}>
                            <Settings size={14} className="text-white/60" /> {t('styleDemo.context.settings')}
                        </button>
                        <button className={`w-full text-left px-3 py-2 text-sm rounded-md hover:bg-white/10 transition-colors flex items-center gap-3 text-white/80`}>
                            <Backpack size={14} className="text-white/60" /> {t('styleDemo.context.toInventory')}
                        </button>
...
function LayoutVariant1({ activeTab }: { activeTab: string }) {
    const { t } = useTranslation();
    const attributes = [
        t('styleDemo.labels.constitution'),
        t('styleDemo.labels.agility'),
        t('styleDemo.labels.thinking')
    ];
        ...
        <div className="flex gap-6 items-start">
            {activeTab === 'stats' && (
                ...
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}><span>{t('styleDemo.sections.woundsBar')}</span></div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-white/30 text-xs">{t('styleDemo.labels.of')}</span>
                            <span className="text-white/50 text-sm font-mono px-2">20</span>
                        </div>
                    </div>
                    <div className="mt-2 text-[10px] text-red-400/60 uppercase text-right tracking-widest">{t('styleDemo.labels.heavilyWounded')}</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-xl p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                    <div className={glass.blockHeader}><span className="text-white">{t('styleDemo.sections.powerSystem')}</span></div>
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center justify-between p-2 rounded-lg bg-black/30 border border-cyan-500/30">
                            <div className="flex items-center gap-2">
                                <Wind size={16} className="text-cyan-400" />
                                <span className="text-cyan-100 text-sm font-bold tracking-wide">{t('styleDemo.labels.astral')}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <span className="text-xs text-white/40">{t('styleDemo.labels.baseColon', { value: 2 })}</span>
                        ...
                        <div className="flex items-center justify-between p-2 rounded-lg bg-black/30 border border-yellow-500/30">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-yellow-100 text-sm font-bold tracking-wide">{t('styleDemo.labels.ether')}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <span className="text-xs text-white/40">{t('styleDemo.labels.baseColon', { value: 3 })}</span>
                        ...
                        <div className="flex items-center justify-between p-2 rounded-lg bg-black/30 border border-fuchsia-500/30">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-fuchsia-100 text-sm font-bold tracking-wide">{t('styleDemo.labels.aura')}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <span className="text-xs text-white/40">{t('styleDemo.labels.baseColon', { value: 1 })}</span>
                ...
                {/* Attributes */}
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}>{t('styleDemo.sections.attributesCompact')}</div>
                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-lg">
                    ...
                    <div className={glass.blockBg}>
                        <div className={glass.blockHeader}>
                            <span>{t('styleDemo.sections.inventoryList')}</span>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="bg-orange-500/10 border-l-2 border-orange-500 p-2 rounded flex justify-between items-center">
                                <div className="flex flex-col">
                                    <span className="text-orange-100 font-bold text-sm flex items-center gap-2"><Sword size={14} className="text-orange-400" /> {t('styleDemo.items.longSword')}</span>
                                    <span className="text-[9px] text-orange-400/70 uppercase">{t('styleDemo.items.meleeWeapon')}</span>
                                </div>
                                <span className="bg-orange-500/20 text-orange-300 px-2 py-0.5 rounded text-xs border border-orange-500/30">{t('styleDemo.items.damageValue', { value: 3 })}</span>
                            </div>
                            {/* Armor colored */}
                            <div className="bg-blue-500/10 border-l-2 border-blue-500 p-2 rounded flex justify-between items-center">
                                <div className="flex flex-col">
                                    <span className="text-blue-100 font-bold text-sm flex items-center gap-2"><Shield size={14} className="text-blue-400" /> {t('styleDemo.items.oldShield')}</span>
                                    <span className="text-[9px] text-blue-400/70 uppercase">{t('styleDemo.items.armor')}</span>
                                </div>
                                <span className="bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded text-xs border border-blue-500/30">{t('styleDemo.items.armorValue', { value: 1 })}</span>
                            </div>
                            {/* Regular Item */}
                            <div className="bg-white/5 border-l-2 border-gray-500 p-2 rounded flex justify-between items-center">
                                <div className="flex flex-col">
                                    <span className="text-gray-200 font-bold text-sm flex items-center gap-2"><Box size={14} className="text-gray-400" /> {t('styleDemo.items.torch')}</span>
                                    <span className="text-[9px] text-gray-500 uppercase">{t('styleDemo.items.light')}</span>
                                </div>
                                <span className="text-gray-500 text-xs">{t('styleDemo.items.quantityValue', { value: 3 })}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {activeTab === 'notes' && (
                <div className="flex-1 flex flex-col gap-6 w-full">
                    <div className={glass.blockBg}>
                        <div className={glass.blockHeader}>{t('styleDemo.sections.logNotes')}</div>
                        <div className="text-white/50 text-sm">{t('styleDemo.notes.story')}</div>
                    </div>
                </div>
            )}
        </div>
...
function LayoutVariant2({ activeTab }: { activeTab: string }) {
    const { t } = useTranslation();
    const attributes = [
        t('styleDemo.labels.body'),
        t('styleDemo.labels.agility'),
        t('styleDemo.labels.thought')
    ];
    ...
    return (
        <div className="flex gap-6 items-start">
            {activeTab === 'stats' && (
                ...
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}><span>{t('styleDemo.sections.woundsSegments')}</span></div>
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex justify-between items-center mt-2">
                            <span className="text-xs text-white/40">{t('styleDemo.labels.healthRemaining')} <strong className="text-white">4</strong></span>
                            <div className="flex gap-1">
                                <button className="p-1 px-3 bg-white/10 hover:bg-white/20 rounded text-xs text-white">{t('styleDemo.actions.woundMinus')}</button>
                                <button className="p-1 px-3 bg-red-500/20 hover:bg-red-500/40 border border-red-500/30 rounded text-xs text-red-200">{t('styleDemo.actions.woundPlus')}</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
                    <div className={glass.blockHeader}><span className="text-white flex items-center gap-2"><Sparkle size={14}/> {t('styleDemo.sections.powerCards')}</span></div>
                    <div className="grid grid-cols-3 gap-3">
                        <div className="flex flex-col items-center bg-cyan-950/20 border border-cyan-500/20 p-3 rounded-xl hover:border-cyan-500/50 transition-colors shadow-[inset_0_0_20px_rgba(6,182,212,0.05)] text-center relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-1 w-full flex justify-end">
                              <span className="text-[8px] bg-cyan-500/20 text-cyan-200 px-1 rounded uppercase tracking-widest border border-cyan-500/30 flex items-center gap-1 group-hover:bg-cyan-500 transition-colors group-hover:text-black">{t('styleDemo.labels.active')}</span>
                            </div>
                            <Wind size={20} className="text-cyan-400 mb-2 mt-2" />
                            <span className="text-cyan-100 text-xs font-bold mb-1">{t('styleDemo.labels.astral')}</span>
                            <span className="text-2xl font-mono text-white mb-2 font-bold drop-shadow-[0_0_5px_rgba(6,182,212,0.8)]">3</span>
                            <span className="text-[10px] text-cyan-400/50 uppercase">{t('styleDemo.labels.baseValue', { value: 2 })}</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center bg-yellow-950/20 border border-yellow-500/20 p-3 rounded-xl hover:border-yellow-500/50 transition-colors text-center grayscale focus-within:grayscale-0 hover:grayscale-0">
                            ...
                            <span className="text-yellow-100/50 text-xs font-bold mb-1">{t('styleDemo.labels.ether')}</span>
                            <span className="text-2xl font-mono text-white/50 mb-2">3</span>
                            <span className="text-[10px] text-yellow-400/30 uppercase">{t('styleDemo.labels.baseValue', { value: 3 })}</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center bg-fuchsia-950/20 border border-fuchsia-500/20 p-3 rounded-xl hover:border-fuchsia-500/50 transition-colors text-center grayscale focus-within:grayscale-0 hover:grayscale-0">
                            ...
                            <span className="text-fuchsia-100/50 text-xs font-bold mb-1">{t('styleDemo.labels.aura')}</span>
                            <span className="text-2xl font-mono text-white/50 mb-2">1</span>
                            <span className="text-[10px] text-fuchsia-400/30 uppercase">{t('styleDemo.labels.baseValue', { value: 1 })}</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Attributes Grid */}
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}>{t('styleDemo.sections.attributesGrid')}</div>
                    <div className="grid grid-cols-3 gap-3">
                        {attributes.map((a) => (
            ...
            {activeTab === 'inventory' && (
                <div className="flex-1 flex flex-col gap-6 w-full max-w-2xl">
                    ...
                    <div className={glass.blockBg}>
                        <div className={glass.blockHeader}>
                            <span>{t('styleDemo.sections.inventoryGrid')}</span>
                            <div className="flex gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="bg-black/30 border-t border-b border-r border-l-4 border-l-orange-500 border-white/5 p-3 rounded-lg flex flex-col justify-between h-24 relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-orange-500/20 rounded-bl-lg px-2 py-0.5 border-b border-l border-orange-500/20">
                                    <span className="text-[9px] text-orange-400 uppercase font-bold tracking-widest">{t('styleDemo.items.weapon')}</span>
                                </div>
                                <div className="flex items-start gap-2 pt-1">
                                    <div className="bg-orange-500/10 p-1.5 rounded"><Sword size={16} className="text-orange-400" /></div>
                                    <span className="text-orange-100 font-bold text-sm leading-tight">{t('styleDemo.items.longSword')}</span>
                                </div>
                                <div className="mt-auto">
                                    <span className="bg-orange-900/50 text-orange-200 px-2 py-0.5 rounded text-xs font-mono">{t('styleDemo.items.damageValue', { value: 3 })}</span>
                                </div>
                            </div>
                            ...
                            <div className="bg-black/30 border-t border-b border-r border-l-4 border-l-blue-500 border-white/5 p-3 rounded-lg flex flex-col justify-between h-24 relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-blue-500/20 rounded-bl-lg px-2 py-0.5 border-b border-l border-blue-500/20">
                                    <span className="text-[9px] text-blue-400 uppercase font-bold tracking-widest">{t('styleDemo.items.armor')}</span>
                                </div>
                                <div className="flex items-start gap-2 pt-1">
                                    <div className="bg-blue-500/10 p-1.5 rounded"><Shield size={16} className="text-blue-400" /></div>
                                    <span className="text-blue-100 font-bold text-sm leading-tight">{t('styleDemo.items.oldShield')}</span>
                                </div>
                                <div className="mt-auto">
                                    <span className="bg-blue-900/50 text-blue-200 px-2 py-0.5 rounded text-xs font-mono">{t('styleDemo.items.armorValue', { value: 1 })}</span>
                                </div>
                            </div>
                            ...
                            <div className="bg-black/30 border-t border-b border-r border-l-4 border-l-gray-500 border-white/5 p-3 rounded-lg flex flex-col justify-between h-24 relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-gray-500/20 rounded-bl-lg px-2 py-0.5 border-b border-l border-gray-500/20">
                                    <span className="text-[9px] text-gray-400 uppercase font-bold tracking-widest">{t('styleDemo.items.item')}</span>
                                </div>
                                <div className="flex items-start gap-2 pt-1">
                                    <div className="bg-gray-500/10 p-1.5 rounded"><Box size={16} className="text-gray-400" /></div>
                                    <span className="text-gray-200 font-bold text-sm leading-tight">{t('styleDemo.items.strengthPotion')}</span>
                                </div>
                                <div className="mt-auto flex justify-between">
                                    <span className="text-gray-500 text-xs">x3</span>
                                    <button className="text-[10px] bg-white/10 hover:bg-white/20 px-2 py-0.5 rounded text-white transition-colors">{t('styleDemo.actions.drink')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {activeTab === 'notes' && (
                <div className="flex-1 flex flex-col gap-6 w-full">
                    <div className={glass.blockBg}>
                        <div className={glass.blockHeader}>{t('styleDemo.sections.logNotes')}</div>
                        <div className="text-white/50 text-sm">{t('styleDemo.notes.lore')}</div>
                    </div>
                </div>
            )}
        </div>
...
function LayoutVariant3({ activeTab }: { activeTab: string }) {
    const { t } = useTranslation();
    const attributes = [
        `${t('styleDemo.labels.body')} 2`,
        `${t('styleDemo.labels.agility')} 3`,
        `${t('styleDemo.labels.thinking')} 4`,
        `${t('styleDemo.labels.charisma')} 1`,
        `${t('styleDemo.labels.figure')} 2`
    ];
    ...
    return (
        <div className="flex gap-6 items-start w-full">
            {activeTab === 'stats' && (
                ...
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}><span>{t('styleDemo.sections.woundsScale')}</span></div>
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex flex-col items-center justify-center w-16 h-16 rounded-full border-4 border-red-900 relative">
                            ...
                            <span className="text-[8px] text-red-500 relative z-10 -mt-1 uppercase">{t('styleDemo.labels.wounds')}</span>
                        </div>
                        <div className="flex-1">
                            <div className="flex justify-between text-xs text-white/50 mb-1">
                                <span>{t('styleDemo.labels.healthy')}</span>
                                <span>{t('styleDemo.labels.death')}</span>
                            </div>
                ...
                {/* Power - Stacked / Descriptive */}
                <div className="bg-white/5 border border-white/10 rounded-2xl p-4 shadow-xl">
                    <div className={glass.blockHeader}><span className="text-white">{t('styleDemo.sections.powerStacked')}</span></div>
                    <div className="flex gap-4">
                        <div className="flex flex-col gap-2 w-32 border-r border-white/10 pr-4">
                            <span className="text-xs text-white/40 uppercase text-center mb-1 font-bold">{t('styleDemo.labels.activePower')}</span>
                            <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-xl p-3 flex flex-col items-center border border-cyan-400/50 shadow-[0_0_20px_rgba(6,182,212,0.4)]">
                                ...
                                <span className="text-white font-bold">{t('styleDemo.labels.astral')}</span>
                        ...
                        <div className="flex-1 flex flex-col justify-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="w-12 text-right text-xs text-cyan-400 font-bold uppercase">{t('styleDemo.labels.astral')}</span>
                            ...
                            <div className="flex items-center gap-3">
                                <span className="w-12 text-right text-xs text-yellow-500 font-bold uppercase">{t('styleDemo.labels.ether')}</span>
                                <div className="flex-1 h-2 bg-black/40 rounded-full flex">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="w-12 text-right text-xs text-fuchsia-400 font-bold uppercase">{t('styleDemo.labels.aura')}</span>
                                <div className="flex-1 h-2 bg-black/40 rounded-full flex">
                ...
                {/* Attributes (Tags) */}
                <div className={glass.blockBg}>
                    <div className={glass.blockHeader}>{t('styleDemo.sections.attributesInline')}</div>
            ...
            {activeTab === 'inventory' && (
                <div className="flex-1 flex flex-col gap-6 w-full max-w-3xl">
                    ...
                    <div className={glass.blockBg}>
                        <div className={glass.blockHeader}>
                            <span>{t('styleDemo.sections.inventoryDetailed')}</span>
                        </div>
                            ...
                            <div className="bg-gradient-to-r from-orange-500/10 to-transparent border-l-[3px] border-orange-500 rounded p-3">
                                <div className="flex justify-between items-start mb-2">
                                    <div className="flex gap-2">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-orange-100 font-bold leading-none">{t('styleDemo.items.longSword')}</span>
                                            <div className="flex gap-2 mt-1 -ml-1">
                                                <span className="text-[10px] bg-orange-950/60 text-orange-400 px-1.5 border border-orange-900 rounded">{t('styleDemo.items.weapon')}</span>
                                                <span className="text-[10px] bg-black/40 text-gray-400 px-1.5 border border-gray-800 rounded">{t('styleDemo.items.twoHanded')}</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-2 text-sm bg-black/20 p-2 rounded border border-white/5">
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.damage')}</span><span className="text-orange-300 font-mono">3</span></div>
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.accuracy')}</span><span className="text-orange-300 font-mono">+1</span></div>
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.range')}</span><span className="text-white/80 text-[10px] uppercase">{t('styleDemo.items.closeRange')}</span></div>
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.durability')}</span><span className="text-white/80 font-mono">8/10</span></div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-500/10 to-transparent border-l-[3px] border-blue-500 rounded p-3">
                                <div className="flex justify-between items-start mb-2">
                                    <div className="flex gap-2">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-blue-100 font-bold leading-none">{t('styleDemo.items.oldShield')}</span>
                                            <div className="flex gap-2 mt-1 -ml-1">
                                                <span className="text-[10px] bg-blue-950/60 text-blue-400 px-1.5 border border-blue-900 rounded">{t('styleDemo.items.armor')}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-2 text-sm bg-black/20 p-2 rounded border border-white/5">
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.defense')}</span><span className="text-blue-300 font-mono">1</span></div>
                                    <div className="flex justify-between items-center"><span className="text-white/40 text-[10px] uppercase">{t('styleDemo.items.penalty')}</span><span className="text-white/80 font-mono">0</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
