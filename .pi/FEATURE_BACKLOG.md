...
|----|----------|--------|--------|------|---------------|
| `FEAT-PLATFORM-ELECTRON-001` | `F0` | Electron Desktop | Foundation implemented | Electron shell, native folder dialog, native asset reveal, embedded server, package scripts, build artifact metadata, player delivery baseline и dev perf overlay реализованы. | App icon/signing visual metadata, packaged smoke QA. |
