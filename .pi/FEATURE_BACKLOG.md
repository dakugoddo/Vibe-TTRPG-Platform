...
| `FEAT-USABILITY-001` | `F1` | Pre-release UX | Implementation in progress | Pre-release usability pack: asset states, entity quick actions, Notes discoverability, Audio dock states, canvas card readability, startup clarity и Settings reset controls. | Asset states и entity quick actions implemented; дальше Notes discoverability polish. |
