...
| `FEAT-USABILITY-001` | `F1` | Pre-release UX | Implementation in progress | Pre-release usability pack: asset states, entity quick actions, Notes discoverability, Audio dock states, canvas card readability, startup clarity и Settings reset controls. | Asset states, entity quick actions и Notes discoverability implemented; дальше Audio dock states. |
