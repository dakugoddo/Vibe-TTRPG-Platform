...
5. Custom world locales/editor только после отдельного design-doc:
   ...
   - read-only server endpoints, typed client API, Settings preview и pure merge/flatten utils реализованы без записи в мир;
   - следующий безопасный кодовый срез: client-side preview merge выбранного world locale file;
