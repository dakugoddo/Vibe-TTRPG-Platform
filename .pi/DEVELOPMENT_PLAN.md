...
1. Pre-release usability pack:
   ...
   - completed slices: `Asset loading/error/retry foundation`, `Entity quick actions`, `Notes discoverability polish`, `Audio dock states`;
   - текущий пункт: canvas card readability;
   - далее: startup flow, Settings reset controls.
