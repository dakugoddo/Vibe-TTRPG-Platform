...
5. Custom world locales/editor только после отдельного design-doc:
   ...
   - read-only server endpoints, typed client API и Settings preview реализованы без записи в мир;
   - следующий безопасный кодовый срез: pure merge/flatten utils и client-side preview merge;
