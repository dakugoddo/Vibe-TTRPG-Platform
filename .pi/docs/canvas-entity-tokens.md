...
- Entity-level defaults для compact character card: какие статы/ресурсы/действия показывать в overlay, без отдельного боевого режима окна. Gate: `.pi/docs/compact-character-card-defaults-gate.md`.
