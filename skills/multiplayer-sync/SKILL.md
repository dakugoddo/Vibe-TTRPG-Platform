...
description: "Yjs CRDT synchronization, y-websocket topology, file debounce, awareness, permissions, and local-first multiplayer rules for Vibe TTRPG Platform. Use when touching sync, rooms, roles, cursors, persistence, or host/player behavior."
version: 1.0.0
author: Vibe TTRPG Platform
license: MIT
metadata:
  hermes:
    tags: [vibe-ttrpg, multiplayer, yjs, sync, project-skill]
---
## Архитектура
